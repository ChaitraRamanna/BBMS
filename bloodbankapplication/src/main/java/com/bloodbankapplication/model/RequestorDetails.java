...
public class RequestorDetails implements Serializable {
	@Id
	...
	public RequestorDetails(int id, String firstName, String lastName, String password, int age, String address,
